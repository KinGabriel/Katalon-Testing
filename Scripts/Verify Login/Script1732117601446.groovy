...
WebUI.comment('Test 1: Valid Log in')
...
WebUI.comment('Test 2: Invalid Log in')

WebUI.sendKeys(findTestObject('Alumina/Login/txtEmail'), '2235008@slu.edu.ph')

WebUI.sendKeys(findTestObject('Alumina/Login/txtPassword'), '12')

WebUI.click(findTestObject('Alumina/Login/btnLogIn'))

WebUI.comment('Test 3: Blank Fields')
